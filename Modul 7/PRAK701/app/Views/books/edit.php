        ...
        <form action="/books/update/<?= $book['id'] ?>" method="post">
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200">
                <div class="px-8 py-6 border-b border-slate-200 flex items-center justify-between">
                    <h2 class="text-xl font-bold text-slate-800">Edit Buku</h2>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="mt-1.5 relative">
                                ...
                                <input type="text" name="judul" id="judul" value="<?= esc($book['judul']) ?>" placeholder="Masukkan judul buku" class="block w-full rounded-lg border border-slate-300 shadow-sm py-2.5 pl-10 px-4 placeholder:text-slate-400/70 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 relative">
                                ...
                                <input type="text" name="penulis" id="penulis" value="<?= esc($book['penulis']) ?>" placeholder="Masukkan nama penulis" class="block w-full rounded-lg border border-slate-300 shadow-sm py-2.5 pl-10 px-4 placeholder:text-slate-400/70 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 relative">
                                ...
                                <input type="text" name="penerbit" id="penerbit" value="<?= esc($book['penerbit']) ?>" placeholder="Masukkan nama penerbit" class="block w-full rounded-lg border border-slate-300 shadow-sm py-2.5 pl-10 px-4 placeholder:text-slate-400/70 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1.5 relative">
                                ...
                                <input type="number" name="tahun_terbit" id="tahun_terbit" value="<?= esc($book['tahun_terbit']) ?>" placeholder="Masukkan tahun terbit buku" class="block w-full rounded-lg border border-slate-300 shadow-sm py-2.5 pl-10 px-4 placeholder:text-slate-400/70 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            </div>
                        </div>
                    </div>
                </div>
