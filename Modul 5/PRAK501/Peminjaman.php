...
<head>
    ...
    <title>Data Peminjaman - PRAK501</title>
...
<div class="container container-card">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold text-dark m-0 header-title">Data Peminjaman</h2>
        <a href="FormPeminjaman.php" class="btn btn-warning rounded-pill px-3 shadow-sm text-dark fw-semibold btn-sm">+ Tambah</a>
    </div>
    ...
    <div>
        <table class="table table-hover table-bordered align-middle text-center table-fit-mobile w-100">
            ...
            <?php if (empty($peminjaman)): ?>
                <tr>
                    <td colspan="6" class="text-muted py-4">Belum ada transaksi peminjaman.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($peminjaman as $row): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Peminjaman.php?delete=<?= $row['id_peminjaman'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus data peminjaman ini?')">Hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
